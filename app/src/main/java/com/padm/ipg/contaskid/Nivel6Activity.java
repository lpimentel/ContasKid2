...
public class Nivel6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //** Obtenção do nome do jogar proveniente do quinto nível **//
    ...
    public void Comparar(View view){
        ...
        // **Configura falta de resposta por parte do utilizador; som para acerto ou falha; número de vidasr**//
    ...
    //** Método para criação de somas e subtrações e multiplicações **//
    ...
    public void NumAleatorio (){
        ...
        if (score<=999999){
            ...
            if (numAleatorio_um>= 0 && numAleatorio_dois <3){
                resultado = numAleatorio_um + numAleatorio_dois;
                iv_signo.setImageResource(R.drawable.adiciona);
            } else if (numAleatorio_um>= 4 && numAleatorio_dois <7) {
                resultado = numAleatorio_um - numAleatorio_dois;
                iv_signo.setImageResource(R.drawable.subtrai);
            } else {
                resultado = numAleatorio_um * numAleatorio_dois;
                iv_signo.setImageResource(R.drawable.multiplicacao);
            }
            ...
            //** Finaliza o jogo e volta ao início **//

        } else {
            Intent intent = new Intent(this, MainActivity.class);

            Toast.makeText(this, "És um génio!", Toast.LENGTH_LONG).show();
